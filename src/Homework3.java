...
public class Homework3 {
    ...
    public static void ex1() {
        ...
        Tree[] trees = {
            new Pine(50, "Крупные иголки"), 
            new Spruce(100, "Мелкие иголки"),
            new Birch(30, true)};
        int sumAge = 0;
        for (int i = 0; i < trees.length; i++) {
            sumAge += trees[i].getAge();
        }
        System.out.println("Средний возраст деревьев: " + (sumAge / trees.length));
        System.out.println();
    }
    ...
    public static void ex5() {
        ...
        House house2 = new House("Гоголя", 10);
